...
from models.models import db, User, Interview, Question
...
def generate_interview():
    try:
        ...
        # Generate Questions
        questions_data = gemini_service.generate_questions(stack, experience)
...
def get_questions(interview_id):
    ...
    try:
        ...
        for q in questions:
            ...
            latest_answer = Answer.query.filter_by(question_id=q.id).order_by(Answer.created_at.desc()).first()
